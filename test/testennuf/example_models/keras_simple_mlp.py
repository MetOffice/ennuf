...
class SimpleMLP:
    ...
    def build_functional_2():
        ...
        y = tf.keras.layers.Dense(nnodes2, activation="tanh", kernel_regularizer=reg, name="densey4")(y)
        z = tf.keras.layers.Dense(nnodes2, activation=activation, kernel_regularizer=reg, name="densez1")(profile)
        z = tf.keras.layers.Dense(nnodes, activation=None, kernel_regularizer=reg, name="densez2")(z)
        z = tf.keras.layers.Dense(nnodes2, activation="relu", kernel_regularizer=reg, name="densez3")(z)
        z = tf.keras.layers.Dense(nnodes, activation="tanh", kernel_regularizer=reg, name="densez4")(z)

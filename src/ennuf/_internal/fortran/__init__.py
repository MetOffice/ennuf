...
def copy_svr_mod(dest_dir: Path) -> None:
    """Copies the svr mod fortran file to the destination."""
    fortran_dir = Path(__file__).parent
    svr_mod_file = fortran_dir.joinpath("svr_mod.f90")
    shutil.copy(svr_mod_file, dest_dir.joinpath("svr_mod.f90"))